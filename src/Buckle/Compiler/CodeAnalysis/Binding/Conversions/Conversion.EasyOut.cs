    ...
    internal static class EasyOut {
        ...
        static EasyOut() {
            ...
            CastKindMap = new byte[,] {
                ...
                /*  chr */{ BOX, IPL, NON, IDN, IPL, NON, NON, NON, NUL, NUL, NON, NUL, NUL, NON, NON, NON },
                /*  int */{ BOX, XPL, NON, XPL, IDN, IPL, NON, NON, NUL, NUL, NON, NUL, NUL, NUL, NON, NON },
                ...
                /* chr? */{ XNL, XNL, NON, XNL, XNL, NON, NON, NON, NUL, NUL, NON, IDN, NUL, NON, NON, NON },
                /* int? */{ XNL, XNL, NON, XNL, XNL, XNL, NON, NON, NUL, NUL, NON, NUL, IDN, NUL, NON, NON },
