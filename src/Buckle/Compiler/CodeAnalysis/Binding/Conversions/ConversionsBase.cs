...
internal abstract partial class ConversionsBase {
    ...
    internal bool HasImplicitTemplateParameterConversion(TemplateParameterSymbol source, TypeSymbol destination) {
        if (HasImplicitReferenceTemplateParameterConversion(source, destination))
            return true;

        if (HasImplicitBoxingTemplateParameterConversion(source, destination))
            return true;
    ...
    private Conversion ClassifyExplicitNullableConversion(TypeSymbol source, TypeSymbol target) {
        ...
        var unwrappedSource = source.StrippedType();
        var unwrappedDestination = target.StrippedType();
    ...
    private protected static Conversion ToConversion(
