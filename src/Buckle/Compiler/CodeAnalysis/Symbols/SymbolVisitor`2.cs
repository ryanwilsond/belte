...
internal abstract class SymbolVisitor<TArgument, TResult> {
    ...
    internal virtual TResult VisitPointerType(PointerTypeSymbol symbol, TArgument argument) {
        return DefaultVisit(symbol, argument);
    }
    ...
    internal virtual TResult VisitFunctionType(FunctionTypeSymbol symbol, TArgument argument) {
        return DefaultVisit(symbol, argument);
    }
