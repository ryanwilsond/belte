...
internal sealed partial class Executor {
    internal static class MethodInfoCache {
        ...
        internal static MethodInfo Nullable_GetValueOrDefault_T = typeof(Nullable<>).GetMethods().Single(m => m.Name == "GetValueOrDefault" && m.GetParameters().Length == 1);
        ...
        internal static MethodInfo Enum_ToString = typeof(Enum).GetMethod("ToString", InstFlags, Type.EmptyTypes);
