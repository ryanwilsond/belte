...
public enum DiagnosticCode : ushort {
    ...
    ERR_CallArgMixing = 317,
    ERR_MismatchedRefEscapeInTernary = 318,
    ERR_RefReturnLocal = 319,
    ERR_RefReturnLocal2 = 320,
    ERR_RefReturnNonreturnableLocal = 321,
    ERR_RefReturnNonreturnableLocal2 = 322,
    ERR_EscapeOther = 323,
    ERR_RefReturnParameter = 324,
    ERR_RefReturnOnlyParameter = 325,
    ERR_RefReturnScopedParameter = 326,
    ...
    ERR_ImplicitlyTypedLocalAssignedBadValue = 345,
