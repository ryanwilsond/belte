...
public enum DiagnosticCode : ushort {
    ...
    ERR_TemplateObjectBaseWithValueTypeBase = 148,
    ERR_TemplateBaseConstraintConflict = 149,
    ERR_TemplateBaseBothReferenceAndValueType = 150,
    ...
    ERR_ReferenceTypeConstraintFailed = 330,
    ERR_ValueConstraintFailed = 331,
    ...
    ERR_CantChangeConstOnOverride = 511,
    ...
    ERR_NonNullableReceiver = 516,
    ERR_NonNullableReceiverArray = 517,
    ...
    ERR_DuplicateInterfaceWithTupleNamesInBaseList = 540,
    ERR_DuplicateInterfaceWithDifferencesInBaseList = 541,
    ERR_DefaultInterfaceImplementation = 542,
    ERR_InterfacesCantContainConstructors = 543,
    ERR_OnlyClassesCanContainFinalizers = 544,
    ERR_InterfacesCantContainFields = 545,
    ERR_InterfacesCantContainConversionOrEqualityOperators = 546,
    ERR_ExplicitImplementationOfOperatorsMustBeStatic = 547,
    ERR_ExplicitInterfaceImplementationInNonClassOrStruct = 548,
    ERR_ExplicitInterfaceImplementationNotInterface = 549,
    ERR_ClassDoesntImplementInterface = 550,
    ERR_ExplicitInterfaceMemberReturnTypeMismatch = 551,
    ERR_ExplicitInterfaceMemberTypeMismatch = 552,
    ...
    ERR_InvalidMultilineString = 571,
    ...
    ERR_DuplicateBehaviorSpecifier = 597,
    ERR_MemoizeRequiresPureSpecifier = 598,
    ERR_InvalidBehaviorSpecifier = 599,
    ERR_CannotAllocateInNoAllocContext = 600,
    ERR_InvalidCallInSpecifierContext = 601,
    ERR_ImpureWriteInPureContext = 602,
    ERR_ImpureReadInPureContext = 603,
    ERR_ThrowInNoThrowContext = 604,
    ERR_PureMethodCannotHaveReverse = 605,
    ERR_CantChangeSpecifierOnOverride = 606,
    WRN_DifferentSpecifierOnOverride = 607,
    ERR_ThisDownCastInConstructor = 608,
    WRN_PotentialUninitializedObjectLeak = 609,
    ...
    ERR_CompileTimeTemplateMustBeType = 614,
    ...
    ERR_DefaultValueCannotReferenceLocals = 651,
    ERR_PropertyCantHaveVoidType = 652,
    ERR_InvalidCompileTimeExpressionState = 653,
    ERR_CompileTimeExpressionThrew = 654,
    INF_CompileTimeExpressionThrew = 655,
