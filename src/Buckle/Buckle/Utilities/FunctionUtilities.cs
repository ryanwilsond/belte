...
internal static class FunctionUtilities {
    ...
    internal static T LookupMethod<T>(IDictionary<FunctionSymbol, T> functions, FunctionSymbol function) {
    ...
    private static (FunctionSymbol, T) LookupMethod<T>(IDictionary<FunctionSymbol, T> functions, string name) {
        foreach (var pair in functions) {
