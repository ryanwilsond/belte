...
internal enum DiagnosticCode : int {
    ...
    ERR_ParameterAleadyDeclared = 13,
    ERR_InvalidMain = 14,
    ...
    ERR_NoValue = 24,
    ERR_ExpectedExpression = 25,
    ERR_ExpectedStatement = 26,
    ...
    ERR_VoidVariable = 55,
    ERR_CannotApplyIndexing = 56,
    WRN_UnreachableCode = 57,
    WRN_AlwaysValue = 58,
}
